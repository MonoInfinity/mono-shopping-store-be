...
namespace store.Src.ProductModule.Test
{
    public class ProductControllerTest
    {
        ...
        //     this.productController = new ProductController(productService, addCategoryDtoValidator, addSubCategoryDtoValidator, addProductDtoValidator, deleteProductDtoValidator, updateProductDtoValidator, uploadFileService);
        ...
        // [Fact]
        // public void passDeleteAProduct()
        // {
        //     DeleteProductDto product = new DeleteProductDto();
        //     product.productId = productDB.productId;
        //     var deleteProduct = this.productController.DeleteProduct(product);
        //     var res = this.productController.GetAProduct(product.productId);
        //     Assert.Equal(404, res.StatusCode);
        // }

        // [Fact]
        // public void failDeleteAProduct()
        // {
        //     DeleteProductDto product = new DeleteProductDto();
        //     product.productId = "003ff45e-48e9-4d17-ac81-b5b03cd220cf";
        //     var res = this.productController.DeleteProduct(product);
        //     Assert.Equal(404, res.StatusCode);
        // }
    }
}