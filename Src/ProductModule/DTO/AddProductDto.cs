...
namespace store.Src.ProductModule.DTO
{
    public class AddProductDto
    {
        ...
        public AddProductDto(string name, string description, string location, double wholesalePrice, double retailPrice, int quantity, string imageUrl, string subCategoryId)
        {
            this.name = name;
